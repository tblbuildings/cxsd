...
// http://localhost:8080/greenPower/greenPowerCommon.xsd
// http://localhost:8080/greenPower/offsitePurchase.xsd
// http://localhost:8080/greenPower/onsiteRenewableDetail.xsd
// http://localhost:8080/greenPower/onsiteRenewableOptionalInfo.xsd
...
// http://localhost:8080/property/customMetrics.xsd
...
// http://localhost:8080/propertyUse/evChargingStation.xsd
// http://localhost:8080/propertyUse/fastFoodRestaurant.xsd
...
// http://localhost:8080/propertyUse/manufacturingIndustrialPlant.xsd
...
// http://localhost:8080/propertyUse/preschoolDaycare.xsd
...
// http://localhost:8080/propertyUse/restaurant.xsd
...
// http://localhost:8080/propertyUse/vehicleRepairServices.xsd
...
interface _AdditionalIdentifierTypeType extends BaseType {
	...
	group?: AdditionalIdentifierTypeTypeGroupType;
...
type AdditionalIdentifierTypeTypeGroupType = ("CITY_TOWN" | "COUNTY_DISTRICT" | "STATE_PROVINCE" | "OTHER");
interface _AdditionalIdentifierTypeTypeGroupType extends Primitive._string { content: AdditionalIdentifierTypeTypeGroupType; }
...
type _costType = Primitive._number;
...
interface _CustomMetricType extends BaseType {
	/** The unique identifier of the custom metric. */
	id: number;
	unitOfMeasure: string;
}
interface CustomMetricType extends _CustomMetricType { constructor: { new(): CustomMetricType }; }
...
interface _DetailsTypesType extends BaseType {
	detailType: DetailTypeType[];
}
interface DetailsTypesType extends _DetailsTypesType { constructor: { new(): DetailsTypesType }; }

interface _DetailTypeType extends BaseType {
	id: number;
	name: string;
}
interface DetailTypeType extends _DetailTypeType { constructor: { new(): DetailTypeType }; }
...
export type energyUomType = ("GJ" | "kBtu (thousand Btu)" | "kWh (thousand Watt-hours)" | "MBtu (million Btu)" | "MWh (million Watt-hours)");
interface _energyUomType extends Primitive._string { content: energyUomType; }
...
interface _evChargingStationType extends BaseType {}
export interface evChargingStationType extends _evChargingStationType { constructor: { new(): evChargingStationType }; }
export var evChargingStationType: { new(): evChargingStationType };

interface _fastFoodRestaurantType extends BaseType {}
export interface fastFoodRestaurantType extends _fastFoodRestaurantType { constructor: { new(): fastFoodRestaurantType }; }
export var fastFoodRestaurantType: { new(): fastFoodRestaurantType };
...
interface _generationLocationType extends BaseType {
...
export interface generationLocationType extends _generationLocationType { constructor: { new(): generationLocationType }; }
export var generationLocationType: { new(): generationLocationType };

type generationLocationTypeEGridSubRegionType = string;
type _generationLocationTypeEGridSubRegionType = Primitive._string;

type generationLocationTypePostalCodeType = string;
type _generationLocationTypePostalCodeType = Primitive._string;

export type generationPlantType = string;
type _generationPlantType = Primitive._string;

export type greenPowerFuelSourceEnum = ("Biogas" | "Biomass" | "Geothermal" | "Small Hydropower" | "Solar" | "Wind" | "Other");
interface _greenPowerFuelSourceEnum extends Primitive._string { content: greenPowerFuelSourceEnum; }

export type greenPowerTypeEnum = ("Community Choice Aggregation" | "Community Solar" | "Competitive Product (direct purchase)" | "Financial/Virtual PPA" | "Physical PPA" | "Unbundled RECs" | "Utility Green Tariff" | "Utility Product" | "Unknown");
interface _greenPowerTypeEnum extends Primitive._string { content: greenPowerTypeEnum; }
...
interface _lengthOfUseDetailType extends _useAttributeBase {
	units: lengthUnitsType;
	value?: number;
}
export interface lengthOfUseDetailType extends _lengthOfUseDetailType { constructor: { new(): lengthOfUseDetailType }; }
export var lengthOfUseDetailType: { new(): lengthOfUseDetailType };
...
interface _manufacturingIndustrialPlantType extends BaseType {}
export interface manufacturingIndustrialPlantType extends _manufacturingIndustrialPlantType { constructor: { new(): manufacturingIndustrialPlantType }; }
export var manufacturingIndustrialPlantType: { new(): manufacturingIndustrialPlantType };
...
interface _meterCategoryType extends Primitive._string { content: meterCategoryType; }
...
interface _offsiteGreenPowerPurchaseType extends BaseType {}
export interface offsiteGreenPowerPurchaseType extends _offsiteGreenPowerPurchaseType { constructor: { new(): offsiteGreenPowerPurchaseType }; }
export var offsiteGreenPowerPurchaseType: { new(): offsiteGreenPowerPurchaseType };
...
interface _OnsiteRenewableDetailsType extends BaseType {
	links?: linksType;
	onsiteRenewableDetail?: onsiteRenewableDetailType[];
}
interface OnsiteRenewableDetailsType extends _OnsiteRenewableDetailsType { constructor: { new(): OnsiteRenewableDetailsType }; }

interface _onsiteRenewableDetailType extends BaseType {}
export interface onsiteRenewableDetailType extends _onsiteRenewableDetailType { constructor: { new(): onsiteRenewableDetailType }; }
export var onsiteRenewableDetailType: { new(): onsiteRenewableDetailType };

interface _onsiteRenewableOptionalInfoType extends BaseType {}
export interface onsiteRenewableOptionalInfoType extends _onsiteRenewableOptionalInfoType { constructor: { new(): onsiteRenewableOptionalInfoType }; }
export var onsiteRenewableOptionalInfoType: { new(): onsiteRenewableOptionalInfoType };

interface _onsiteUsageDetailType extends BaseType {
	...
	/** The generation location of the REC, required when recOwnership is
	...
	greenPowerType?: greenPowerTypeEnum;
	...
	recOwnership: recOwnershipEnum;
}
export interface onsiteUsageDetailType extends _onsiteUsageDetailType { constructor: { new(): onsiteUsageDetailType }; }
export var onsiteUsageDetailType: { new(): onsiteUsageDetailType };
...
interface _ped extends BaseType {
	month: number;
	year: number;
}
export interface ped extends _ped { constructor: { new(): ped }; }
export var ped: { new(): ped };

type pedMonthType = number;
type _pedMonthType = Primitive._number;

type pedYearType = number;
type _pedYearType = Primitive._number;
...
type _percentageType = Primitive._number;
...
interface _periodType extends Primitive._string { content: periodType; }
...
interface _plantDataType extends _useAttributeBase {
	textValue?: string;
	value?: plantDataTypeValueType;
}
export interface plantDataType extends _plantDataType { constructor: { new(): plantDataType }; }
export var plantDataType: { new(): plantDataType };

type plantDataTypeValueType = ("Aerospace and defense" | "Durable assembled products - Electronics" | "Durable assembled products - Electrical components and appliances" | "Durable assembled products - Furniture" | "Durable assembled products - Machinery (HVAC, boilers, turbines, pumps, etc.)" | "Durable assembled products-Other" | "Food Manufacturing - Animal food" | "Food Manufacturing - Animal processing" | "Food Manufacturing - Bread and roll" | "Food Manufacturing - Brewery" | "Food Manufacturing - Cookies and cracker" | "Food Manufacturing - Dairy" | "Food Manufacturing - Distillery" | "Food Manufacturing - Frozen fried potato" | "Food Manufacturing - Fruit and vegetable canning" | "Food Manufacturing - Juices" | "Food Manufacturing - Sugar" | "Food Manufacturing - Wet corn milling" | "Food Manufacturing - Other" | "Paper - Paper mill" | "Paper - Pulp mill" | "Paper - Integrated pulp and paper mill" | "Paper - Recycled paper mill" | "Paper - Other" | "Medical equipment" | "Personal care" | "Pharmaceutical" | "Printing" | "Mining and extraction" | "Petroleum and chemicals - Asphalt paving and roofing" | "Petroleum and chemicals - Chlor-alkyl" | "Petroleum and chemicals - Ethylene" | "Petroleum and chemicals - Fertilizer-Nitrogenous" | "Petroleum and chemicals - Fertilizer-Other" | "Petroleum and chemicals - Industrial gases" | "Petroleum and chemicals - Petroleum refining" | "Petroleum and chemicals - Other" | "Plastic and rubber products" | "Cement" | "Concrete" | "Composite Manufacturing" | "Glass - Flat" | "Glass - Container" | "Glass - Other" | "Gypsum (wallboard, molding, etc.)" | "Lime" | "Metals - Aluminum processing" | "Metals - Steel mill" | "Metals - Metal Machining and Fabrication" | "Metals - Metal casting" | "Metals - Metal Finishing/Coating" | "Metals - Tool and Die Manufacturing" | "Metals - Other" | "Motor Vehicle - Assembly" | "Motor Vehicle - Transmission" | "Motor Vehicle - Engine" | "Motor Vehicle - Tire Manufacturing" | "Motor Vehicle - Other" | "Textiles Manufacturing" | "Wood" | "Other");
interface _plantDataTypeValueType extends Primitive._string { content: plantDataTypeValueType; }
...
interface _preschoolDaycareType extends BaseType {}
export interface preschoolDaycareType extends _preschoolDaycareType { constructor: { new(): preschoolDaycareType }; }
export var preschoolDaycareType: { new(): preschoolDaycareType };
...
interface _ratedCapacityUomType extends Primitive._string { content: ratedCapacityUomType; }

export type recOwnershipEnum = ("Owned" | "Not Owned/Sold" | "Arbitraged" | "Unknown");
interface _recOwnershipEnum extends Primitive._string { content: recOwnershipEnum; }
...
export type renewableGenerationTechnologyEnum = ("Solar PV- Carports" | "Solar PV- Ground-mounted" | "Solar PV- Rooftop" | "Solar Thermal- Concentrating Solar Power" | "Other");
interface _renewableGenerationTechnologyEnum extends Primitive._string { content: renewableGenerationTechnologyEnum; }

interface _report extends BaseType {}
...
interface _reportMetrics extends BaseType {
	/** A group of metrics. This corresponds to the groups that the metrics are organized into in the user interface. */
	group: reportMetricsGroupType[];
}
export interface reportMetrics extends _reportMetrics { constructor: { new(): reportMetrics }; }
export var reportMetrics: { new(): reportMetrics };

interface _reportMetricsGroupType extends BaseType {
	/** The unique identifier of the metric group. */
	id: number;
	/** The name of the metric group as it appears in the user interface. */
	name: string;
	metrics: reportMetricsGroupTypeMetricsType;
}
interface reportMetricsGroupType extends _reportMetricsGroupType { constructor: { new(): reportMetricsGroupType }; }

interface _reportMetricsGroupTypeMetricsType extends BaseType {
	/** The metric. */
	metric?: reportMetricsGroupTypeMetricsTypeMetricType[];
}
...
interface _reportMetricsGroupTypeMetricsTypeMetricType extends BaseType {
	...
	id: number;
	/** The unique web service metric name identifier to reference the metric. */
	name: string;
	/** The unit of measure of the value returned by the metric (if applicable). */
	uom: string;
}
interface reportMetricsGroupTypeMetricsTypeMetricType extends _reportMetricsGroupTypeMetricsTypeMetricType { constructor: { new(): reportMetricsGroupTypeMetricsTypeMetricType }; }
...
interface _restaurantType extends BaseType {}
export interface restaurantType extends _restaurantType { constructor: { new(): restaurantType }; }
export var restaurantType: { new(): restaurantType };
...
interface _timeframeType extends BaseType {
	...
	currentPeriod: timeframeTypeCurrentPeriodType;
	/** Returns metrics for each property's current year and its baseline year. */
	currentVsBaseline: timeframeTypeCurrentVsBaselineType;
	...
	dateRange: timeframeTypeDateRangeType;
	/** Returns metrics for a specific year that you specify. */
	singlePeriod: timeframeTypeSinglePeriodType;
	/** Returns metrics for each property in two specific years that you select. */
	twoPeriods: timeframeTypeTwoPeriodsType;
}
export interface timeframeType extends _timeframeType { constructor: { new(): timeframeType }; }
export var timeframeType: { new(): timeframeType };

interface _timeframeTypeBaselinePeriodType extends BaseType {}
interface timeframeTypeBaselinePeriodType extends _timeframeTypeBaselinePeriodType { constructor: { new(): timeframeTypeBaselinePeriodType }; }

interface _timeframeTypeCompareBaselinePeriodType extends BaseType {}
interface timeframeTypeCompareBaselinePeriodType extends _timeframeTypeCompareBaselinePeriodType { constructor: { new(): timeframeTypeCompareBaselinePeriodType }; }

interface _timeframeTypeCompareCurrentPeriodType extends BaseType {}
interface timeframeTypeCompareCurrentPeriodType extends _timeframeTypeCompareCurrentPeriodType { constructor: { new(): timeframeTypeCompareCurrentPeriodType }; }

interface _timeframeTypeCurrentPeriodType extends BaseType {}
interface timeframeTypeCurrentPeriodType extends _timeframeTypeCurrentPeriodType { constructor: { new(): timeframeTypeCurrentPeriodType }; }

interface _timeframeTypeCurrentVsBaselineType extends BaseType {}
interface timeframeTypeCurrentVsBaselineType extends _timeframeTypeCurrentVsBaselineType { constructor: { new(): timeframeTypeCurrentVsBaselineType }; }

interface _timeframeTypeDateRangeType extends BaseType {}
interface timeframeTypeDateRangeType extends _timeframeTypeDateRangeType { constructor: { new(): timeframeTypeDateRangeType }; }

interface _timeframeTypeSinglePeriodType extends BaseType {}
interface timeframeTypeSinglePeriodType extends _timeframeTypeSinglePeriodType { constructor: { new(): timeframeTypeSinglePeriodType }; }

interface _timeframeTypeTwoPeriodsType extends BaseType {}
interface timeframeTypeTwoPeriodsType extends _timeframeTypeTwoPeriodsType { constructor: { new(): timeframeTypeTwoPeriodsType }; }
...
interface _vehicleRepairServicesType extends BaseType {}
export interface vehicleRepairServicesType extends _vehicleRepairServicesType { constructor: { new(): vehicleRepairServicesType }; }
export var vehicleRepairServicesType: { new(): vehicleRepairServicesType };
...
export interface document extends BaseType {
	...
	office: officeType;
	offsiteGreenPowerPurchase: offsiteGreenPowerPurchaseType;
	/** Presence of an on-site Laundry Facility (Yes/No). */
	onSiteLaundryFacility: useYesNoType;
	onsiteRenewableDetail: onsiteRenewableDetailType;
	onsiteRenewableDetails: OnsiteRenewableDetailsType;
	onsiteRenewableOptionalInfo: onsiteRenewableOptionalInfoType;
	/** Total area of open parking lots/areas. */
	openFootage: grossFloorAreaType;
	/** Indication of regular activities that occur on either Saturday or Sunday (Yes/No). */
	openOnWeekends: useYesNoType;
	...
	/** Restaurant refers to buildings used for preparation and sale of ready-to-eat food, but which do not fit in the fast food property type. Examples include fast casual, casual, fine dining restaurants, and all other buildings where the primary business is the onsite preparation and sale of ready-to-eat food to the general public. */
	...
	/** The type of template. This is ignored in a POST/PUT. */
	...
	/** Vehicle Repair Services refers to buildings in which vehicle servicing and repair occurs. Vehicle types serviced are limited to buses, light-, medium- and heavy-duty cars and trucks. */
